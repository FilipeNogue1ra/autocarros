...
@Composable
fun Opcoes(paddingValues: PaddingValues = PaddingValues(0.dp)) { // Aceita paddingValues, com um valor padrão
    Box(
        modifier = Modifier
            .fillMaxSize()
        ...
        Text(text = "Conteúdo do Ecrã Opções") // Alterado o texto para refletir o ecrã
    }
}
